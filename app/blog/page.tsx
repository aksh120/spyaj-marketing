...
const posts = [
    {
        ...
        excerpt: "Discover the strategies that will define the future of business-to-business commerce.",
        date: "Dec 28, 2024",
        category: "Trends"
    },
    {
        ...
        excerpt: "Learn how to reduce costs and improve efficiency in your logistics operations.",
        date: "Dec 25, 2024",
        category: "Logistics"
    },
    {
        ...
        excerpt: "Why manufacturers must adapt to new technologies to stay competitive.",
        date: "Dec 20, 2024",
        category: "Technology"
    }
];
    ...
    return (
        <div className="max-w-7xl mx-auto px-4 md:px-6 py-8 md:py-20 pt-[80px] md:pt-[120px]">
            <div className="text-center mb-16">
                ...
                <p className="text-muted-foreground text-lg">News, tips, and trends from the world of B2B.</p>
            </div>
                ...
                {posts.map((post, idx) => (
                    ...
                    >
                        <div className="aspect-video bg-muted relative overflow-hidden">
                            ...
                            <span className="absolute top-4 left-4 bg-background/80 backdrop-blur-sm px-2 py-1 rounded text-xs font-bold">{post.category}</span>
                        </div>
                        <div className="p-6">
                            ...
                            <h3 className="font-bold text-xl mb-3 group-hover:text-primary transition-colors line-clamp-2">{post.title}</h3>
                            <p className="text-muted-foreground text-sm mb-6 line-clamp-3">{post.excerpt}</p>
                            <Link href={`/blog/${post.slug}`} className="text-primary font-bold text-sm flex items-center gap-1 group/link">
