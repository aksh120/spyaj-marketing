                ...
                >
                    ...
                    <motion.button
                        ...
                        className={cn(
                            ...
                            isFilterOpen ? "bg-primary text-primary-foreground border-primary" : "border-border hover:bg-muted"
                        )}
                    >
            ...
            <div className="flex gap-6 md:gap-10" ref={containerRef}>
                ...
                >
                    ...
                    <div className="bg-card border-2 border-border rounded-2xl p-5">
                        ...
                        <div className="px-2">
                            ...
                            <div className="flex justify-between text-xs text-muted-foreground mt-2">
                                <span>₹0</span>
                                <span className="font-bold text-foreground">₹{priceRange[1].toLocaleString()}</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-gradient-to-br from-primary/10 to-primary/5 border-2 border-primary/20 rounded-2xl p-5">
                        ...
                        <div className="space-y-2 text-sm">
                            {["Solar Panels", "CNC Machines", "Cotton Fabric"].map((item, idx) => (
                                <motion.div
                                    key={item}
                                    initial={{ opacity: 0 }}
                                    animate={{ opacity: 1 }}
                ...
                <div className="flex-1">
                    ...
                    >
                        ...
                        <div className="flex items-center gap-2 md:gap-4">
                            ...
                            <div className="flex items-center gap-1.5 md:gap-2 px-2 md:px-3 py-1 md:py-1.5 border-2 border-border rounded-lg bg-card">
                                <span className="text-[10px] md:text-xs text-muted-foreground">Sort:</span>
                                <select
                    ...
                    <motion.div
                        ...
                        className={cn(
                            "gap-3 md:gap-6",
                            viewMode === "grid" ? "grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3" : "flex flex-col"
                        )}
                    >
                        <AnimatePresence mode="popLayout">
                            {filteredProducts.map((product, idx) => (
                                <motion.div
                                    ...
                                    className={cn(
                                        "group bg-background border-2 border-border rounded-xl md:rounded-2xl overflow-hidden transition-all duration-300",
                                        hoveredProduct === product.id && "border-primary/50 shadow-xl shadow-primary/10"
                                    )}
                                >
                                        ...
                                        {product.badge && (
                                            <motion.div
                                                ...
                                                className={cn(
                                                    ...
                                                    product.badge === "Top Rated" && "bg-yellow-500 text-black",
                                    ...
                                    <div className="p-3 md:p-5 bg-card">
                                        ...
                                        <div className="text-[10px] md:text-xs text-muted-foreground mb-2 md:mb-4">
                                            <span className="font-semibold text-foreground">{product.orders.toLocaleString()}</span> orders
                                        </div>

                                        <div className="flex items-center justify-between">
                                            <div>
                                                <span className="text-lg md:text-2xl font-bold text-primary">{product.price}</span>
                                                <span className="text-[8px] md:text-xs text-muted-foreground ml-1">/ Unit</span>
                                            </div>
                                        </div>
                                        ...
                                        <motion.button
                                            ...
                                            whileTap={{ scale: 0.98 }}
                                            className="w-full mt-3 bg-primary text-primary-foreground border-2 border-primary py-2 md:py-3 rounded-lg md:rounded-xl font-bold text-xs md:text-sm hover:bg-primary/90 hover:shadow-lg hover:shadow-primary/30 transition-all"
                                        >
                                            Connect Now
                                        </motion.button>
                                    </div>
