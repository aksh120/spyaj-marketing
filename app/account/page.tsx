...
const recentActivity = [
  {
    title: "Inquiry received for 'Steel Pipes'",
    time: "2 hours ago",
    status: "New",
  ...
  {
    title: "Listing 'Solar Panels' updated",
    time: "5 hours ago",
    status: "Updated",
  ...
  {
    title: "Message from 'EcoEnergy Systems'",
    time: "1 day ago",
    status: "Unread",
  ...
  {
    title: "New follower: Metro Industries",
    time: "2 days ago",
    status: "New",
  ...
  {
    title: "Quote request for bulk order",
    time: "3 days ago",
    status: "Pending",
...
const notifications = [
  {
    id: 1,
    title: "New inquiry from Rahul Industries",
    time: "10 min ago",
    read: false,
  },
  {
...
export default function Dashboard() {
  ...
  const [activeTab, setActiveTab] = useState<"activity" | "analytics">(
    "activity",
  );
      ...
      >
        {stats.map((stat, idx) => (
          ...
          >
            ...
            <h4 className="text-muted-foreground text-xs md:text-sm font-medium mb-0.5 md:mb-1">
              {stat.title}
            </h4>
            <motion.p
              initial={{ opacity: 0 }}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8">
                    ...
                    >
                      <div className="flex items-center gap-3 md:gap-4">
                        <motion.div
                          ...
                          className={cn(
                            "p-2 rounded-lg",
                            activity.statusColor.replace("bg-", "bg-") + "/10",
                          )}
                        >
                          <span
                            className={activity.statusColor.replace(
                              "bg-",
                              "text-",
                            )}
                          >
                        ...
                        <span
                          className={cn(
                            ...
                            activity.statusColor +
                              "/20 " +
                              activity.statusColor.replace("bg-", "text-"),
                          )}
                        >
                          {activity.status}
                        </span>
        ...
        <div className="space-y-4 md:space-y-6">
          <motion.div
            ...
            whileHover={{
              y: -5,
              boxShadow: "0 20px 40px rgba(var(--primary), 0.2)",
            }}
          ...
          >
            ...
            <div className="relative">
              ...
              <p className="opacity-80 text-xs md:text-sm mb-4 md:mb-6">
                Enjoy unlimited listings and priority support.
              </p>
              <motion.button
