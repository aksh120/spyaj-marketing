...
const mockProducts = [
  {
    ...
    inquiries: 45,
    revenue: "₹2.5L",
    image: "https://loremflickr.com/200/200/yarn",
  },
  {
    id: 2,
    ...
    inquiries: 32,
    revenue: "₹4.2L",
    image: "https://loremflickr.com/200/200/pipes",
  },
  {
    id: 3,
    ...
    inquiries: 28,
    revenue: "₹1.8L",
    image: "https://loremflickr.com/200/200/led",
  },
];
    ...
    <div className="max-w-7xl mx-auto px-4 md:px-6 py-8 pt-[100px]">
      ...
      >
        ...
        <p className="text-muted-foreground">
          Monitor your store performance and manage inquiries.
        </p>
      </motion.div>
        ...
        >
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex items-center gap-4 text-xs">
              <span className="flex items-center gap-1">
                <span className="w-3 h-3 bg-primary rounded-full" /> Views
              </span>
              <span className="flex items-center gap-1">
                <span className="w-3 h-3 bg-green-500 rounded-full" /> Inquiries
              </span>
            </div>
          </div>
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <SimpleLineChart
                data={[
                  120, 150, 130, 180, 200, 175, 220, 190, 250, 230, 280, 260,
                ]}
                height={100}
                color="primary"
              />
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-muted-foreground">
                    {product.views.toLocaleString()} views • {product.inquiries}{" "}
                    inquiries
                  </p>
                </div>
