...
import { Mail, Phone, MapPin, Send, MessageCircle, Clock, CheckCircle2, Loader2, ArrowRight, Sparkles } from "lucide-react";
...
const faqs = [
    { q: "How do I become a seller?", a: "Register on our platform, complete verification, and start listing your products." },
    { q: "What payment methods are accepted?", a: "We accept bank transfers, cards, UPI, and escrow payments for secure transactions." },
    { q: "How long does shipping take?", a: "Domestic orders: 3-7 days. International: 10-21 days depending on destination." },
];
                ...
                <div className="space-y-6 md:space-y-10">
                    ...
                    >
                        {contactMethods.map((method, idx) => (
                            ...
                            >
                                ...
                                <h4 className="font-bold text-sm md:text-base mb-1">{method.title}</h4>
                                <p className="text-xs md:text-sm text-muted-foreground mb-3">{method.desc}</p>
                                <motion.span
                                    whileHover={{ x: 5 }}
                    ...
                    >
                        ...
                        <div className="flex gap-3 md:gap-4 text-muted-foreground">
                            ...
                            <div>
                                <p className="text-sm md:text-base font-semibold text-foreground mb-1">SPYAJ Marketing Pvt. Ltd.</p>
                                <p className="text-sm md:text-base">123 Business, Industrial Zone,<br />Pune, Maharashtra, India - 364001</p>
                            </div>
                        </div>
                    </motion.div>
                        ...
                        {isSubmitted ? (
                            ...
                            >
                                <div className="text-center mb-6">
                                    <h3 className="text-lg md:text-2xl font-bold mb-1">Send us a message</h3>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                                    ...
                                    <motion.div
                                        ...
                                        className="space-y-1.5 md:space-y-2"
                                    >
                                        <label className="text-xs md:text-sm font-semibold">Business Email</label>
                                        <input
                                            type="email"
                                ...
                                <motion.div
                                    ...
                                    className="space-y-1.5 md:space-y-2"
                                >
                                    <label className="text-xs md:text-sm font-semibold">Subject</label>
                                    <select
                                ...
                                <motion.div
                                    ...
                                    className="space-y-1.5 md:space-y-2"
                                >
                                    <label className="text-xs md:text-sm font-semibold">Message</label>
                                    <textarea
                                        rows={4}
                                ...
                                <motion.button
                                    whileHover={{ scale: 1.02, boxShadow: "0 20px 40px rgba(var(--primary)/0.3)" }}
                                    whileTap={{ scale: 0.98 }}
