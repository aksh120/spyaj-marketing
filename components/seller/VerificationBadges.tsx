...
export function VerificationBadges({
    ...
    const tierBg = {
        ...
        Bronze: "bg-orange-100 dark:bg-orange-900/30 text-orange-700 dark:text-orange-300 border-orange-200 dark:border-orange-800",
    };
    ...
    return (
        <div className={cn("space-y-4", className)}>
            ...
            >
                <div className={cn("w-6 h-6 rounded-full bg-gradient-to-br flex items-center justify-center", tierColors[tier])}>
...
export function FactoryTourVideo({
    ...
    return (
        <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            className={cn("relative rounded-xl overflow-hidden border-2 border-border", className)}
        >
