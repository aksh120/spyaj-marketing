...
import { Facebook, Twitter, Instagram, Linkedin, Mail, ArrowRight, MapPin, Phone, Globe, ChevronUp } from "lucide-react";
                ...
                >
                    <div className="col-span-2">
                        ...
                        <p className="text-muted-foreground text-xs md:text-sm leading-relaxed mb-4 md:mb-6 max-w-xs">
                            India's most trusted B2B marketplace for global trade and local sourcing. Connect with verified suppliers worldwide.
                        </p>

                        <div className="mb-6">
                            <h4 className="font-bold text-sm md:text-base mb-2 md:mb-3">Subscribe to Newsletter</h4>
                    ...
                    <div>
                        <h4 className="font-bold text-sm md:text-base mb-3 md:mb-4">Marketplace</h4>
                    ...
                    <div>
                        <h4 className="font-bold text-sm md:text-base mb-3 md:mb-4">Resources</h4>
                        <ul className="space-y-2 md:space-y-3">
                    ...
                    <div>
                        <h4 className="font-bold text-sm md:text-base mb-3 md:mb-4">Company</h4>
