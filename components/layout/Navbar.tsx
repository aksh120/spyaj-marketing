        ...
        >
            <div className="max-w-7xl mx-auto flex items-center justify-between gap-2 md:gap-6">
                ...
                <div className="hidden lg:block relative">
                    ...
                    >
                        ...
                        <span className="text-sm font-medium text-muted-foreground">{selectedCity}</span>
                        <ChevronDown className={cn("w-4 h-4 text-muted-foreground transition-transform", isCityDropdownOpen && "rotate-180")} />
                    </button>
                        ...
                        >
                            ...
                            <div className="max-h-[300px] overflow-y-auto">
                                {filteredCities.length > 0 ? (
                                    ...
                                    <div className="p-4">
                                        <p className="text-sm text-muted-foreground mb-3">No cities found</p>
                                        {citySearchQuery && (
                                            <button
                                                onClick={() => {
                                            ...
                                            >
                                                <span className="font-semibold">Use "{citySearchQuery}"</span>
                                            </button>
                                        )}
                                    </div>
                                )}
            ...
            {isMobileMenuOpen && (
                ...
                >
                    ...
                    <Link href="/auth/sign-in" className="text-lg font-medium py-2" onClick={() => setIsMobileMenuOpen(false)}>Sign In</Link>
                </motion.div>
            )}
        </nav>
    );
